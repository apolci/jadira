...
public class TimeColumnLocalTimeMapper extends AbstractTimeThreeTenColumnMapper<LocalTime> implements DatabaseZoneConfigured<ZoneId> {
	...
	public TimeColumnLocalTimeMapper(ZoneId databaseZone) {
