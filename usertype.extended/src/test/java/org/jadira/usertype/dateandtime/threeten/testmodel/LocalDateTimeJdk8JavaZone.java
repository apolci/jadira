...
@TypeDef(name = "test_LocalDateTimeJdk8ParamType", typeClass = PersistentLocalDateTime.class, parameters= {
		@Parameter(name="databaseZone", value="jvm")
		,
		@Parameter(name="javaZone", value="jvm")
})
public class LocalDateTimeJdk8JavaZone implements Serializable {
    ...
    @Column
    @Type(type = "test_LocalDateTimeJdk8ParamType")
